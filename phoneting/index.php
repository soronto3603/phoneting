...
<body>
  ...
  <div id=contents>
    <!-- <div class="line box_shadow">
      <div class=line_left>
        <img src="girl_photos/123.JPG">
      </div>
      <div class=line_right>
        <div class="line_left_title line_left_left_margin line_left_right_margin">
          따뜻함을 드리겠습니다.
        </div>
        <div class="line_left_text line_left_left_margin line_left_right_margin">
          쓸씀마음을 달래주고 따듯함을 드리고 싶어요 저와 함께 행복한 시간을 가져요.
        </div>
        <div class="line_left_button_call line_left_left_margin">
          전화하기
        </div>
      </div>
      <div class=clear></div>
